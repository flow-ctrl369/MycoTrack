...
class MycoTrackerApp:
    def __init__(self, root):
        ...
        self.tabs = {
            ...
            "Analytics": VisualizationFrame(self.notebook, self.db)
        }
        ...
        refresh_button = ttk.Button(self.tabs["Analytics"], text="Refresh Analytics", 
                                  command=self.refresh_analytics)
        refresh_button.pack(pady=10)

    def refresh_analytics(self):
        """Refresh the analytics visualizations"""
