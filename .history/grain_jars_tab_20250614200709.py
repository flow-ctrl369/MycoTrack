...
class GrainJarsTab(ttk.Frame):
    ...
    def setup_form(self):
        # Dictionary to hold form variables
        self.form_vars = {}

        # Jar ID
        ttk.Label(self.form_frame, text="Jar ID:").grid(row=0, column=0, padx=5, pady=5, sticky="w")
        self.form_vars["jar_id"] = ttk.Entry(self.form_frame, font=("TkDefaultFont", 14))
        self.form_vars["jar_id"].grid(row=0, column=1, padx=5, pady=5, sticky="ew")
        ...
        # Inoculation Date
        ttk.Label(self.form_frame, text="Inoculation Date:").grid(row=2, column=0, padx=5, pady=5, sticky="w")
        self.form_vars["inoculation_date"] = DateEntry(self.form_frame, width=24, background="#262626", foreground="#f0f0f0", headersbackground="#262626", headersforeground="#f0f0f0")
        self.form_vars["inoculation_date"].grid(row=2, column=1, sticky="w", padx=10, pady=6)

        # Colonization %
        ttk.Label(self.form_frame, text="Colonization %:").grid(row=3, column=0, padx=5, pady=5, sticky="w")
        self.form_vars["colonization_percentage"] = ttk.Spinbox(
            self.form_frame, 
            from_=0, 
            to=100, 
            width=24,
        ...
        self.form_vars["colonization_percentage"].grid(row=3, column=1, sticky="w", padx=10, pady=6)

        # Shake Date
        ttk.Label(self.form_frame, text="Shake Date:").grid(row=4, column=0, padx=5, pady=5, sticky="w")
        self.form_vars["shake_date"] = DateEntry(self.form_frame, width=24, background="#262626", foreground="#f0f0f0", headersbackground="#262626", headersforeground="#f0f0f0")
        self.form_vars["shake_date"].grid(row=4, column=1, sticky="w", padx=10, pady=6)

        # Contamination Notes
        ttk.Label(self.form_frame, text="Contamination Notes:").grid(row=5, column=0, padx=5, pady=5, sticky="w")
        self.form_vars["contamination_notes"] = tk.Text(self.form_frame, height=4, width=38, bg="#262626", fg="#f0f0f0", insertbackground="#f0f0f0", font=(None, 14))
        self.form_vars["contamination_notes"].grid(row=5, column=1, sticky="w", padx=10, pady=6)

        # Buttons frame
        button_frame = ttk.Frame(self.form_frame)
        button_frame.grid(row=6, column=0, columnspan=2, pady=18)
    ...
    def clear_form(self):
        ...
        self.form_vars["viability"].set("Healthy")  # Reset viability to default
        self.form_vars["substrate_type"].set("CVG") # Reset substrate type
