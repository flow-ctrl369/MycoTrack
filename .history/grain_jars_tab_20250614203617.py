...
class GrainJarsTab(ttk.Frame):
    ...
    def setup_form(self):
        # Search frame (moved to top of form)
        ...
        # Export button (moved to top of form)
        ttk.Button(search_frame, text="Export to CSV", command=self.export_selected).pack(side=tk.RIGHT, padx=(0,10), ipadx=8, ipady=4)
