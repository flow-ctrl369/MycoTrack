...
class MycoTrackerApp:
    ...
    def check_for_reminders(self):
        ...
        reminders_to_check = self.db.cursor.execute('''
            SELECT id, task, reminder_date, reminder_time, recurrence_type, recurrence_interval, recurrence_end_date
            FROM reminders
        ...
        for reminder_id, task, reminder_date_str, reminder_time_str, recurrence_type, recurrence_interval, recurrence_end_date_str in reminders_to_check:
