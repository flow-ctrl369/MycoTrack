...
class ThemeManager:
    ...
    def update_widget_colors(self, widget, colors):
        ...
        try:
            ...
            # For ttk widgets, they should generally pick up styles from apply_theme
            # However, if a specific ttk widget is not updating, a refresh might be needed
            # No need to re-call style.configure for each ttk widget here, as it's global.
            # The issue with Combobox not updating might be related to its internal structure
            # or theme interactions.
            # Let's ensure ttk widgets that might not automatically refresh get a push.
            # This is a bit of a workaround if style.map or configure is not fully propagating.
