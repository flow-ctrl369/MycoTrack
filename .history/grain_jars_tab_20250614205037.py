...
class GrainJarsTab(ttk.Frame):
    ...
    def setup_search(self):
        ...
        ttk.Button(search_frame, text="Import from CSV", command=self.import_from_csv).pack(side=tk.RIGHT, padx=(5, 10), ipadx=8, ipady=4)
        ttk.Button(search_frame, text="Export to CSV", command=self.export_selected).pack(side=tk.RIGHT, padx=(0, 5), ipadx=8, ipady=4)
