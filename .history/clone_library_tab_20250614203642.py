...
class CloneLibraryTab(ttk.Frame):
    ...
    def setup_form(self):
        ...
        for i, (label_text, field_name) in enumerate(fields):
            ttk.Label(self.form_frame, text=label_text).grid(row=i+1, column=0, sticky="e", padx=10, pady=6)
            ...
            if field_name == "date_taken":
                ...
                self.form_vars[field_name].grid(row=i+1, column=1, sticky="w", padx=10, pady=6)
        ...
        button_frame.grid(row=len(fields)+1, column=0, columnspan=2, pady=18)
